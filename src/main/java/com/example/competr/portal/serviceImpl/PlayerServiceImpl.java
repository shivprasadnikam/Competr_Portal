...
public class PlayerServiceImpl implements PlayerService {
    ...
    public RegisterUserResponse registerUser(PlayerDto playerDto) {
        ...
        try {
            ...
            log.info("User registered successfully with userName: {}", savedEntity.getUserName());
            return registerUserResponse;
        } catch (Exception e) {
    ...
    public LoginResponse loginUser(LoginRequest loginRequest) {
        ...
        if (userOpt.isPresent()) {
            ...
            if (matches) {
                ...
                log.info("Login successful for userName: {}, phoneNumber: {}", playerEntity.getUserName(), phoneNumber);

                loginResponse.setUserId(playerEntity.getUserName());
    ...
    @Override
    public List<String> searchPlayersByName(String playerName){
        return playerRepository.findUserNamesByUserNameContainingIgnoreCase(playerName);
    }
